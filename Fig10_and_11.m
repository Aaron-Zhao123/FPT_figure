...
subplot(2,1,1)
for i = 1:size(n,1)
    fig2 = plot(p_vec, C_fp(i,:),'--r','LineWidth',2 ); hold on
    fig1 = plot(p_vec, C_online(i,:),'b','LineWidth',2); hold on
    %fig3 = plot(p_vec, C_fp_SISO(i,:),'-.c','LineWidth',2); hold on
...
fig_legend = legend ([fig2,fig1],'fp\_PISO','online');
...
%     fig3 = plot(p_vec, L_fp_SISO(i,:),'-.c','LineWidth',2); hold on
